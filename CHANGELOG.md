...
## [0.1.0](https://github.com/SamYusuf101/foundry-zksync/compare/foundry-zksync-v0.0.22...foundry-zksync-v0.1.0) (2025-07-18)


### ⚠ BREAKING CHANGES

* **forge:** strip "revert: " from  vm.expectRevert reason ([#10144](https://github.com/SamYusuf101/foundry-zksync/issues/10144))

### bug

* **forge:** strip "revert: " from  vm.expectRevert reason ([#10144](https://github.com/SamYusuf101/foundry-zksync/issues/10144)) ([89b7470](https://github.com/SamYusuf101/foundry-zksync/commit/89b7470b50f2ea6ae500b8d6000ebc1b62866282))


### Features

* **`anvil`:** add support for trace logging in Anvil ([#9895](https://github.com/SamYusuf101/foundry-zksync/issues/9895)) ([623f852](https://github.com/SamYusuf101/foundry-zksync/commit/623f85244ade044ed8ea2cd7109936949e075b43))
* **`anvil`:** bypass sidecar requirement when impersonating ([#10224](https://github.com/SamYusuf101/foundry-zksync/issues/10224)) ([9dbf916](https://github.com/SamYusuf101/foundry-zksync/commit/9dbf916bd5df1c0f01d9e61dc0d586eea31152d9))
* **`anvil`:** emit warning server side on failing request ([#9890](https://github.com/SamYusuf101/foundry-zksync/issues/9890)) ([51b75c8](https://github.com/SamYusuf101/foundry-zksync/commit/51b75c83045a963a48f9cd8d765e0f2e775acb3e))
* **`cast age`:** clarify block timestamp is UTC to allow for `date` compatibility ([#9913](https://github.com/SamYusuf101/foundry-zksync/issues/9913)) ([087c676](https://github.com/SamYusuf101/foundry-zksync/commit/087c676e65a425eb02efc99680e452a09da98fa5))
* **`cast`:** add new `cast wallet remove` command ([#9873](https://github.com/SamYusuf101/foundry-zksync/issues/9873)) ([3afcab4](https://github.com/SamYusuf101/foundry-zksync/commit/3afcab4e2227e39962c7c44229324cd8a1e9d772))
* **`cast`:** getTransactionBySenderAndNonce ([#10323](https://github.com/SamYusuf101/foundry-zksync/issues/10323)) ([23b1cbd](https://github.com/SamYusuf101/foundry-zksync/commit/23b1cbd6ef131838629be51ad8f5f9391239eb4d))
* **`cast`:** make unsigned raw txs ([#10105](https://github.com/SamYusuf101/foundry-zksync/issues/10105)) ([4c798f6](https://github.com/SamYusuf101/foundry-zksync/commit/4c798f65b70cab0b1565eb012124227c853327d2))
* **`common`:** `PathOrContractInfo` arg type  ([#9770](https://github.com/SamYusuf101/foundry-zksync/issues/9770)) ([db3d9fc](https://github.com/SamYusuf101/foundry-zksync/commit/db3d9fc95398450dbed83d4841042c62c155bcfc))
* **`forge fmt`:** add watch mode ([#9838](https://github.com/SamYusuf101/foundry-zksync/issues/9838)) ([67be473](https://github.com/SamYusuf101/foundry-zksync/commit/67be473b54778ba15b454e597e3d50960b920900))
* **`forge`:** don't commit installations by default ([#9884](https://github.com/SamYusuf101/foundry-zksync/issues/9884)) ([6b3cf56](https://github.com/SamYusuf101/foundry-zksync/commit/6b3cf56e38fada3e468f6018b456be94d5c032e6))
* **`forge`:** remove `testFail*` ([#9574](https://github.com/SamYusuf101/foundry-zksync/issues/9574)) ([abf269e](https://github.com/SamYusuf101/foundry-zksync/commit/abf269ea4f79307b796174e50c0233d1cd9d512f))
* **abi:** Implement UIfmt for DSTest console logs ([#10185](https://github.com/SamYusuf101/foundry-zksync/issues/10185)) ([7825a06](https://github.com/SamYusuf101/foundry-zksync/commit/7825a06862b0c97a510618f5c6901eca279e4802))
* add `--alloy-rev` and fix `forge bind` re-run on built project ([#9861](https://github.com/SamYusuf101/foundry-zksync/issues/9861)) ([1bcd17c](https://github.com/SamYusuf101/foundry-zksync/commit/1bcd17c8299d7c0792a77b2d4a0cf2c531a5cab2))
* add `cast chain` support for `ink` & `ink-sepolia` ([13051f0](https://github.com/SamYusuf101/foundry-zksync/commit/13051f0ea45b2c7de3a0a2e56a0a4c08f6aaba5b))
* add `cast chain` support for `ink` & `ink-sepolia` ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* add `cast chain` support for `ink` & `ink-sepolia` ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* add `cast chain` support for `ink` & `ink-sepolia` ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* add `gas_snapshot_check` flag to config, fix `FORGE_SNAPSHOT_CHECK` behavior ([#9791](https://github.com/SamYusuf101/foundry-zksync/issues/9791)) ([fe92e7e](https://github.com/SamYusuf101/foundry-zksync/commit/fe92e7ef225c6380e657e49452ce931871ae56bc))
* add `vm.foundryVersionCmp` and `vm.foundryVersionAtLeast` cheatcodes ([#9845](https://github.com/SamYusuf101/foundry-zksync/issues/9845)) ([7e8c6e9](https://github.com/SamYusuf101/foundry-zksync/commit/7e8c6e937848be26ae486f00a164ab200830fc66))
* add `x86_64-musl` and `aarch64-musl` release targets ([#9984](https://github.com/SamYusuf101/foundry-zksync/issues/9984)) ([ef4553e](https://github.com/SamYusuf101/foundry-zksync/commit/ef4553e2041fb7a74081a55b295185e6ac38368e))
* add 7702 support to eth-sendtransaction ([#10504](https://github.com/SamYusuf101/foundry-zksync/issues/10504)) ([eef4acd](https://github.com/SamYusuf101/foundry-zksync/commit/eef4acdbcb4dd8bfe0894052750b051fe5a31754))
* add Alpine Linux support to foundryup ([#10257](https://github.com/SamYusuf101/foundry-zksync/issues/10257)) ([96c40b6](https://github.com/SamYusuf101/foundry-zksync/commit/96c40b6ad6ca444e52520d1ee5e7e84d8aa08b22))
* add cast da-estimate ([#10588](https://github.com/SamYusuf101/foundry-zksync/issues/10588)) ([8cb2125](https://github.com/SamYusuf101/foundry-zksync/commit/8cb21251f64f28e15aa3f2b996af75edb6ebc43d))
* add devcontainer ([#10429](https://github.com/SamYusuf101/foundry-zksync/issues/10429)) ([48533bb](https://github.com/SamYusuf101/foundry-zksync/commit/48533bbc06da4206299ae806469440013347ee8c))
* add explicit_iter_loop clippy lint ([#10146](https://github.com/SamYusuf101/foundry-zksync/issues/10146)) ([44c4416](https://github.com/SamYusuf101/foundry-zksync/commit/44c4416e1982496599958498750fc238f9596362))
* Add file option for calldata input ([#10397](https://github.com/SamYusuf101/foundry-zksync/issues/10397)) ([33cb8d2](https://github.com/SamYusuf101/foundry-zksync/commit/33cb8d2faf6787ddecde2af7343ee472bdf829ee))
* add mathjax support to forge doc mdbook config ([#9829](https://github.com/SamYusuf101/foundry-zksync/issues/9829)) ([1baa9e6](https://github.com/SamYusuf101/foundry-zksync/commit/1baa9e6aa2c3fac588564fc7339e3b5ff5d2f3a1))
* add option to store keystore file with custom account name ([#9946](https://github.com/SamYusuf101/foundry-zksync/issues/9946)) ([eaf0650](https://github.com/SamYusuf101/foundry-zksync/commit/eaf06504595da45d0107b5870faea66f382f097a))
* add serde derive ([4add5dc](https://github.com/SamYusuf101/foundry-zksync/commit/4add5dcfa63d2631753ec7e84c5f20f1561ea8f3))
* add serde derive ([f697e54](https://github.com/SamYusuf101/foundry-zksync/commit/f697e548f8d75d07b868ffe6975cc1bb3168d82d))
* add serde derive ([5106b68](https://github.com/SamYusuf101/foundry-zksync/commit/5106b6845614ac830a9edcabf21ec0d1aa694d7e))
* add serde derive ([1af14bc](https://github.com/SamYusuf101/foundry-zksync/commit/1af14bc9ecc3000cb4af52913579135525e68069))
* add serde derive ([41506ca](https://github.com/SamYusuf101/foundry-zksync/commit/41506cadeb4b1c609dfa5ab77348c285346b0464))
* add serde derive to forge bind ([#10332](https://github.com/SamYusuf101/foundry-zksync/issues/10332)) ([41506ca](https://github.com/SamYusuf101/foundry-zksync/commit/41506cadeb4b1c609dfa5ab77348c285346b0464))
* add support for cast estimate ([#903](https://github.com/SamYusuf101/foundry-zksync/issues/903)) ([5eaf1a7](https://github.com/SamYusuf101/foundry-zksync/commit/5eaf1a794e98086e3ff1900e384e62b95448dd70))
* Add support for cast send --create  ([#913](https://github.com/SamYusuf101/foundry-zksync/issues/913)) ([9aaddd6](https://github.com/SamYusuf101/foundry-zksync/commit/9aaddd6507039cf031599b81ede78fde75b28f6d))
* add support for custom signature in cast fields ([#935](https://github.com/SamYusuf101/foundry-zksync/issues/935)) ([4b59d03](https://github.com/SamYusuf101/foundry-zksync/commit/4b59d03591fccb6ecd3a21a8605e83c52122d969))
* Add support for zksolc 1.5.12 ([#1002](https://github.com/SamYusuf101/foundry-zksync/issues/1002)) ([274cc62](https://github.com/SamYusuf101/foundry-zksync/commit/274cc622bde9b0c8c17ff469260e10e2d3b7c36b))
* add telemetry ([#1008](https://github.com/SamYusuf101/foundry-zksync/issues/1008)) ([e9e5df3](https://github.com/SamYusuf101/foundry-zksync/commit/e9e5df314b4a3fb111626967011270afb92ee3f5))
* add verify-bytecode support ([#994](https://github.com/SamYusuf101/foundry-zksync/issues/994)) ([f872d3c](https://github.com/SamYusuf101/foundry-zksync/commit/f872d3c82e5f828ebc84dc506cbf2d2e412c722b))
* add vm.getChain(chainAlias)  ([#10226](https://github.com/SamYusuf101/foundry-zksync/issues/10226)) ([1da4d32](https://github.com/SamYusuf101/foundry-zksync/commit/1da4d324652b3a61f7c7128a6d28f9d6239e8218))
* add way to disable emitting of gas snapshots to disk ([#9710](https://github.com/SamYusuf101/foundry-zksync/issues/9710)) ([5f6bd20](https://github.com/SamYusuf101/foundry-zksync/commit/5f6bd2087d9a595196e5c1a1491b416d51692d9f))
* added rpc method to deal ERC20 tokens ([#10495](https://github.com/SamYusuf101/foundry-zksync/issues/10495)) ([3e1c72b](https://github.com/SamYusuf101/foundry-zksync/commit/3e1c72b97cdffdced87d49c7fecf625e4035a559))
* added TransactionStream to subscribe to pending transactions ([#10482](https://github.com/SamYusuf101/foundry-zksync/issues/10482)) ([59030b8](https://github.com/SamYusuf101/foundry-zksync/commit/59030b8bf7d9d76824e471f62699682440a2a2c4))
* **anvil:** add block context overrides for eth_call and eth_estimateGas ([#10487](https://github.com/SamYusuf101/foundry-zksync/issues/10487)) ([7b6a9f3](https://github.com/SamYusuf101/foundry-zksync/commit/7b6a9f3cafac7daad535dca5c745f456dde42566))
* **anvil:** add eth_simulateV1 rpc call ([#10227](https://github.com/SamYusuf101/foundry-zksync/issues/10227)) ([92e020e](https://github.com/SamYusuf101/foundry-zksync/commit/92e020e54c8fa3e05749c5213cce403e17007c01))
* **anvil:** add genesis number to configuration and update related structures ([#10083](https://github.com/SamYusuf101/foundry-zksync/issues/10083)) ([1f22112](https://github.com/SamYusuf101/foundry-zksync/commit/1f22112b4e9586e39924ab851c055088c3973683))
* **anvil:** add holocene and isthmus optimism hardforks ([#9949](https://github.com/SamYusuf101/foundry-zksync/issues/9949)) ([1bfde08](https://github.com/SamYusuf101/foundry-zksync/commit/1bfde087063cd11605814c8cc2cd956576ea92f3))
* **anvil:** implement `anvil_rollback` ([#9783](https://github.com/SamYusuf101/foundry-zksync/issues/9783)) ([fbfd9bc](https://github.com/SamYusuf101/foundry-zksync/commit/fbfd9bc6c52946bfc79c30384dde22efb81bafd5))
* **backend:transact_from_tx:** take `inspect_ctx` ([013b96d](https://github.com/SamYusuf101/foundry-zksync/commit/013b96d7caf224ead5bcb407ec937d34f42da866))
* broadcast raw transaction cheatcode ([#958](https://github.com/SamYusuf101/foundry-zksync/issues/958)) ([013b96d](https://github.com/SamYusuf101/foundry-zksync/commit/013b96d7caf224ead5bcb407ec937d34f42da866))
* bump `alpine=3.21` in Dockerfile ([#9907](https://github.com/SamYusuf101/foundry-zksync/issues/9907)) ([ac982da](https://github.com/SamYusuf101/foundry-zksync/commit/ac982da859b2950f1d1dcfb4230611377beb7c27))
* cast call --trace support ([#953](https://github.com/SamYusuf101/foundry-zksync/issues/953)) ([0ff41b2](https://github.com/SamYusuf101/foundry-zksync/commit/0ff41b2be31c9bdc886327649793104fce12fbb0))
* cast mktx and mktx --create support ([#911](https://github.com/SamYusuf101/foundry-zksync/issues/911)) ([4f89e2f](https://github.com/SamYusuf101/foundry-zksync/commit/4f89e2fd316edb4a8ad013779679ea55ce7a4e03))
* **cast mktx:** add support for "--ethsign" option ([#10641](https://github.com/SamYusuf101/foundry-zksync/issues/10641)) ([496598b](https://github.com/SamYusuf101/foundry-zksync/commit/496598b3717354780de294898da83c19143010b5))
* cast run ([#1013](https://github.com/SamYusuf101/foundry-zksync/issues/1013)) ([6bd3238](https://github.com/SamYusuf101/foundry-zksync/commit/6bd32385610dffea90a22c69f1b6041661b82361))
* **cast:zk:** `call` and `call --create` support ([#917](https://github.com/SamYusuf101/foundry-zksync/issues/917)) ([2eaac65](https://github.com/SamYusuf101/foundry-zksync/commit/2eaac658af0152576ce6515db650787199a4abb7))
* **cast:** add `cast txpool` ([#10104](https://github.com/SamYusuf101/foundry-zksync/issues/10104)) ([ab9a9e5](https://github.com/SamYusuf101/foundry-zksync/commit/ab9a9e50ea4d89464c42a2665bbaaac1993429d1))
* **cast:** Include recover_authority when logging SignedAuthorization ([#10349](https://github.com/SamYusuf101/foundry-zksync/issues/10349)) ([77aec59](https://github.com/SamYusuf101/foundry-zksync/commit/77aec5998edc1ba4d72bd66c09a8df7d206e09d4))
* **cast:** storage add --proxy to manually specify a proxy contract when Etherscan fails to find it ([#10033](https://github.com/SamYusuf101/foundry-zksync/issues/10033)) ([a431586](https://github.com/SamYusuf101/foundry-zksync/commit/a4315867cdd3e88193c9e1b3fa088739c06381ff))
* **cast:** update polygon testnet chain and add polygon zkevm chains ([#9803](https://github.com/SamYusuf101/foundry-zksync/issues/9803)) ([14e09e3](https://github.com/SamYusuf101/foundry-zksync/commit/14e09e333637fc4ec4d78dca148dc0ce65bb835b))
* **cast:** Verbose signing output ([#10529](https://github.com/SamYusuf101/foundry-zksync/issues/10529)) ([477876a](https://github.com/SamYusuf101/foundry-zksync/commit/477876a87fea0cd8e2c398f23f836189f2aad58c))
* **cheatcodes:** add `expectCreate` and `expectCreate2` ([#9875](https://github.com/SamYusuf101/foundry-zksync/issues/9875)) ([f3130a5](https://github.com/SamYusuf101/foundry-zksync/commit/f3130a52937039a7e82b4aef07143139c322d09f))
* dynamic ZKsync/LLVM solc revision selection ([#1055](https://github.com/SamYusuf101/foundry-zksync/issues/1055)) ([9120621](https://github.com/SamYusuf101/foundry-zksync/commit/9120621eddb9372392da2cf574270f5136c5fd06))
* Etherscan V2 support ([#10440](https://github.com/SamYusuf101/foundry-zksync/issues/10440)) ([0f87460](https://github.com/SamYusuf101/foundry-zksync/commit/0f8746073a26301da8622bb9ed2542642b1c79ca))
* filter by profile in getCode ([13051f0](https://github.com/SamYusuf101/foundry-zksync/commit/13051f0ea45b2c7de3a0a2e56a0a4c08f6aaba5b))
* filter by profile in getCode ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* filter by profile in getCode ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* filter by profile in getCode ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* **forge build:** add `--use-literal-content` CLI flag ([#10143](https://github.com/SamYusuf101/foundry-zksync/issues/10143)) ([654c8f0](https://github.com/SamYusuf101/foundry-zksync/commit/654c8f01721e43dbc8a53c7a3b022548cb82b2f9))
* **forge/script:** decode execution traces when `--json` is enabled ([#10109](https://github.com/SamYusuf101/foundry-zksync/issues/10109)) ([b811823](https://github.com/SamYusuf101/foundry-zksync/commit/b8118232de784e6bb650b95cbdc3b65172c80494))
* **forge:** add `vm.stopRecord` ([#10370](https://github.com/SamYusuf101/foundry-zksync/issues/10370)) ([378ded1](https://github.com/SamYusuf101/foundry-zksync/commit/378ded105929fefac358d5c0a3d7d2870ddb3ae5))
* **forge:** add accessList and cold/warm cheatcodes ([#10112](https://github.com/SamYusuf101/foundry-zksync/issues/10112)) ([0dd4d31](https://github.com/SamYusuf101/foundry-zksync/commit/0dd4d3153764f4706c2c9857675e42dec64155a7))
* **forge:** add new cheatcode `attachBlob` to send EIP-4844 transaction ([#10336](https://github.com/SamYusuf101/foundry-zksync/issues/10336)) ([e988893](https://github.com/SamYusuf101/foundry-zksync/commit/e9888937e032b3b4729b2e902c1eaf51f84a9948))
* **forge:** add option to suppress successful tests traces ([#9865](https://github.com/SamYusuf101/foundry-zksync/issues/9865)) ([e88e563](https://github.com/SamYusuf101/foundry-zksync/commit/e88e5631450e63b46b2d68cf8507974992756012))
* **forge:** add script execution protection config ([#10408](https://github.com/SamYusuf101/foundry-zksync/issues/10408)) ([497b6ee](https://github.com/SamYusuf101/foundry-zksync/commit/497b6ee597a6a8042fc91c361f77eee22aed0cb2))
* **forge:** add vm.deployCode cheats with msg.value and salt ([#10178](https://github.com/SamYusuf101/foundry-zksync/issues/10178)) ([60adcb5](https://github.com/SamYusuf101/foundry-zksync/commit/60adcb5c3a243b739282ae8c25adecb06c8b2625))
* **forge:** add vm.setArbitraryStorage with overwrites ([#10219](https://github.com/SamYusuf101/foundry-zksync/issues/10219)) ([0467078](https://github.com/SamYusuf101/foundry-zksync/commit/04670787fb8049d512baadc87b50c6813e53aad5))
* **forge:** allow invariant contract address as targetContract ([#10274](https://github.com/SamYusuf101/foundry-zksync/issues/10274)) ([dc9ff38](https://github.com/SamYusuf101/foundry-zksync/commit/dc9ff38d161a5b8663131c8b4ede719a1b6ccc23))
* **forge:** allow path in forge selectors upload ([#10073](https://github.com/SamYusuf101/foundry-zksync/issues/10073)) ([213319d](https://github.com/SamYusuf101/foundry-zksync/commit/213319d738fe1c4a8f01a724ad8a8b76ab637255))
* **forge:** cheatcodes to crosschain sign and attach delegation ([#10518](https://github.com/SamYusuf101/foundry-zksync/issues/10518)) ([297d4e2](https://github.com/SamYusuf101/foundry-zksync/commit/297d4e25e1da36a0f1a8e3d0f2e6850375bad3a9))
* **forge:** forge lint ([#10405](https://github.com/SamYusuf101/foundry-zksync/issues/10405)) ([96d107c](https://github.com/SamYusuf101/foundry-zksync/commit/96d107c828d93c34f8b6fd9da6dd84f602d0dc22))
* **forge:** match chain id with token symbol ([#10043](https://github.com/SamYusuf101/foundry-zksync/issues/10043)) ([81fb954](https://github.com/SamYusuf101/foundry-zksync/commit/81fb954d4fbdd4dd4ffa68f7efb04c6a36eacff2))
* **forge:** optimize compilation through preprocessing and caching ([#10010](https://github.com/SamYusuf101/foundry-zksync/issues/10010)) ([b455c5b](https://github.com/SamYusuf101/foundry-zksync/commit/b455c5b70e2e806bd223135dd9da6562cea9a2e1))
* **forge:** revert diagnostic inspector ([#10446](https://github.com/SamYusuf101/foundry-zksync/issues/10446)) ([4332dc4](https://github.com/SamYusuf101/foundry-zksync/commit/4332dc48a5f3a3627d152aa2912138e2c9ef4caa))
* **forge:** script warn if no transactions to broadcast ([#10384](https://github.com/SamYusuf101/foundry-zksync/issues/10384)) ([1a5ff59](https://github.com/SamYusuf101/foundry-zksync/commit/1a5ff59ac6a09472c10cf6cbd1918aa024ebea3b))
* **forge:** vm.sort and vm.shuffle cheatcodes ([#10187](https://github.com/SamYusuf101/foundry-zksync/issues/10187)) ([5699fab](https://github.com/SamYusuf101/foundry-zksync/commit/5699fab4c8917d7d0f542fc552dc88afe543ccc7))
* **foundry-cli::utils:** add support for mimalloc and tracy-allocator ([#10545](https://github.com/SamYusuf101/foundry-zksync/issues/10545)) ([d437c3f](https://github.com/SamYusuf101/foundry-zksync/commit/d437c3f5d9706406fca942e0e4be76aaf9658227))
* implement add_balance endpoint ([#10636](https://github.com/SamYusuf101/foundry-zksync/issues/10636)) ([b1f8767](https://github.com/SamYusuf101/foundry-zksync/commit/b1f876772a1ab2104c82b2fa2c231d117a179100))
* implement compiler backwards compatibility policy ([#843](https://github.com/SamYusuf101/foundry-zksync/issues/843)) ([469b770](https://github.com/SamYusuf101/foundry-zksync/commit/469b7700404178060e6ee135ab967d723851bfa2))
* Improve display format ([#898](https://github.com/SamYusuf101/foundry-zksync/issues/898)) ([6af9b1a](https://github.com/SamYusuf101/foundry-zksync/commit/6af9b1af6c3da8396c951d3164887bd2af583faf))
* improve uninformative error messages ([#10201](https://github.com/SamYusuf101/foundry-zksync/issues/10201)) ([94ba51d](https://github.com/SamYusuf101/foundry-zksync/commit/94ba51d9fb4496520299293134683af9c5b59c10))
* inspect command ([#906](https://github.com/SamYusuf101/foundry-zksync/issues/906)) ([f7059a1](https://github.com/SamYusuf101/foundry-zksync/commit/f7059a156c1efb2f7c8dd350521bb0cf69e8809c))
* **inspect:** set `target_depth` thru inspect_ctx ([013b96d](https://github.com/SamYusuf101/foundry-zksync/commit/013b96d7caf224ead5bcb407ec937d34f42da866))
* **invariant:** generate failed call sequence as solidity ([#9827](https://github.com/SamYusuf101/foundry-zksync/issues/9827)) ([c4ae688](https://github.com/SamYusuf101/foundry-zksync/commit/c4ae68826405e2ecb4ab4c27cbce5ac4e21bf1a3))
* **invariant:** on failures show original and current sequence len ([#9816](https://github.com/SamYusuf101/foundry-zksync/issues/9816)) ([f6133f9](https://github.com/SamYusuf101/foundry-zksync/commit/f6133f9e5fbd37864958cc58457f795ce35cd469))
* remove openssl dependency ([#967](https://github.com/SamYusuf101/foundry-zksync/issues/967)) ([61e3baa](https://github.com/SamYusuf101/foundry-zksync/commit/61e3baa773a4fed65eb47924beff408e8b5681b0))
* retry `zks_getBytecodeByHash` failures ([#1000](https://github.com/SamYusuf101/foundry-zksync/issues/1000)) ([49aa003](https://github.com/SamYusuf101/foundry-zksync/commit/49aa003f113961ccbe9e471829bd0615e9e1a5c3))
* **script:** revert if address(this) used ([#10295](https://github.com/SamYusuf101/foundry-zksync/issues/10295)) ([055b0ea](https://github.com/SamYusuf101/foundry-zksync/commit/055b0ea4311254f89d1b3274eddb07bfac288f6c))
* solc 0.8.29 ([#10078](https://github.com/SamYusuf101/foundry-zksync/issues/10078)) ([6ce4571](https://github.com/SamYusuf101/foundry-zksync/commit/6ce45712a2282006c24711892400d5748f985607))
* solc 0.8.30 ([#10459](https://github.com/SamYusuf101/foundry-zksync/issues/10459)) ([62e880a](https://github.com/SamYusuf101/foundry-zksync/commit/62e880aa8ead919aa47ba3313ced324b92d14e55))
* support `signDelegation ` and `signAndAttachDelegation` with nonce ([#10182](https://github.com/SamYusuf101/foundry-zksync/issues/10182)) ([7a7ad4e](https://github.com/SamYusuf101/foundry-zksync/commit/7a7ad4ea7282c30477d7fc0f39bf631acde7e7bd))
* support negative forkblock numbers ([#10263](https://github.com/SamYusuf101/foundry-zksync/issues/10263)) ([e867a6c](https://github.com/SamYusuf101/foundry-zksync/commit/e867a6c3bffe6d4281dbbc9f0a1fba012d9e2a17))
* support state diff cheatcode ([#922](https://github.com/SamYusuf101/foundry-zksync/issues/922)) ([a7b05d3](https://github.com/SamYusuf101/foundry-zksync/commit/a7b05d38b8a3e14cbda85abdac58dbb8bc19868a))
* update anvil zksync ([#1030](https://github.com/SamYusuf101/foundry-zksync/issues/1030)) ([b62aa65](https://github.com/SamYusuf101/foundry-zksync/commit/b62aa652c5f65b24cb194ef355729a33edf0df4d))
* upstream 4974a08 ([#946](https://github.com/SamYusuf101/foundry-zksync/issues/946)) ([f3a9825](https://github.com/SamYusuf101/foundry-zksync/commit/f3a9825a9b07bee979c94bc26cc80ccc96942eb5))
* Upstream 67be473 ([#924](https://github.com/SamYusuf101/foundry-zksync/issues/924)) ([ca9d1aa](https://github.com/SamYusuf101/foundry-zksync/commit/ca9d1aa4fb54e87f0e1ccad04e2b4f629b4520cc))
* Upstream 9f11e6df ([#899](https://github.com/SamYusuf101/foundry-zksync/issues/899)) ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* Upstream 9f11e6df commits ([#900](https://github.com/SamYusuf101/foundry-zksync/issues/900)) ([13051f0](https://github.com/SamYusuf101/foundry-zksync/commit/13051f0ea45b2c7de3a0a2e56a0a4c08f6aaba5b))
* Upstream ab753e9ca ([#1083](https://github.com/SamYusuf101/foundry-zksync/issues/1083)) ([35f1cb1](https://github.com/SamYusuf101/foundry-zksync/commit/35f1cb187bda0ad8a9b15ad280c516b1202d9863))
* Upstream ab753e9ca-merge ([#1084](https://github.com/SamYusuf101/foundry-zksync/issues/1084)) ([6aa835b](https://github.com/SamYusuf101/foundry-zksync/commit/6aa835bd9def31ec9a4bc22d8ab5cf130d446487))


### Bug Fixes

* **--isolate:** avoid remappings lookups ([#9938](https://github.com/SamYusuf101/foundry-zksync/issues/9938)) ([f44c499](https://github.com/SamYusuf101/foundry-zksync/commit/f44c4996582d1fe5b737462efe8923335d38b73d))
* **`--isolate`:** correctly handle staticcalls ([#9940](https://github.com/SamYusuf101/foundry-zksync/issues/9940)) ([9066359](https://github.com/SamYusuf101/foundry-zksync/commit/9066359bc017179c15e80f866369d7c9d6c060e3))
* **`anvil`:** --chain-id takes precendence over genesis ([#10223](https://github.com/SamYusuf101/foundry-zksync/issues/10223)) ([8937c09](https://github.com/SamYusuf101/foundry-zksync/commit/8937c091c8fc7d138f141eb919b6de40bff0ed93))
* **`anvil`:** fix chain-id precedence ([#10239](https://github.com/SamYusuf101/foundry-zksync/issues/10239)) ([eb336c5](https://github.com/SamYusuf101/foundry-zksync/commit/eb336c520e332dc1a9317de8673ae5baa4354603))
* **`anvil`:** inject the P256 precompile for `--odyssey` upon EVM construction and fix `NotActivated` error for `--optimism` ([#10567](https://github.com/SamYusuf101/foundry-zksync/issues/10567)) ([78cbcc5](https://github.com/SamYusuf101/foundry-zksync/commit/78cbcc537ca5b7de29cd8db58bce6805e095d641))
* **`anvil`:** latest evm version should be prague ([#10653](https://github.com/SamYusuf101/foundry-zksync/issues/10653)) ([db0ce45](https://github.com/SamYusuf101/foundry-zksync/commit/db0ce45719a703c06f789c0c9e6514e1cc4e1c0c))
* **`cast`:** include zero address as known system sender in cast run ([#10608](https://github.com/SamYusuf101/foundry-zksync/issues/10608)) ([3f1e943](https://github.com/SamYusuf101/foundry-zksync/commit/3f1e9433db9c9205a22fb64cfa3ed79ce795e0a8))
* **`cast`:** respect `full` arg in `cast block` ([#10536](https://github.com/SamYusuf101/foundry-zksync/issues/10536)) ([9e53778](https://github.com/SamYusuf101/foundry-zksync/commit/9e53778208a2cdb335d5ef794cb13122b8288364))
* **`ci`:** clippy, allow result too large ([#9999](https://github.com/SamYusuf101/foundry-zksync/issues/9999)) ([19cef98](https://github.com/SamYusuf101/foundry-zksync/commit/19cef98fd4476f6550e3451c5c775dcf9847c45d))
* **`common`:** find target by path if present ([#10538](https://github.com/SamYusuf101/foundry-zksync/issues/10538)) ([71f9b8e](https://github.com/SamYusuf101/foundry-zksync/commit/71f9b8e645abc24da099912ce4d4ce481d26ffad))
* **`forge bind`:** add `serde` as a dependency to generated `Cargo.toml` if `Serde` is being derived in bindings ([#10563](https://github.com/SamYusuf101/foundry-zksync/issues/10563)) ([cd62bc7](https://github.com/SamYusuf101/foundry-zksync/commit/cd62bc7f58a307bad532b043114bd2cfbbe72662))
* `forge script --verifier sourcify` is ignored when `ETHERSCAN_API_KEY` env var is defined ([#10002](https://github.com/SamYusuf101/foundry-zksync/issues/10002)) ([abbcc45](https://github.com/SamYusuf101/foundry-zksync/commit/abbcc451a8ee60726a868136b7056b072f7680c8))
* **`forge test --debug`:** do not panic when user specifies both `--match-path` and `<PATH>` , bail instead ([#10094](https://github.com/SamYusuf101/foundry-zksync/issues/10094)) ([f3be628](https://github.com/SamYusuf101/foundry-zksync/commit/f3be628d9453da53216f6603ed7b7471d5d21fe7))
* **`forge`:** `forge build --sizes` collapses non uniques ([#9962](https://github.com/SamYusuf101/foundry-zksync/issues/9962)) ([4830840](https://github.com/SamYusuf101/foundry-zksync/commit/483084081361fe5b384c3c4aa077cf7990479938))
* **`forge`:** catch faulty test constructors ([#9909](https://github.com/SamYusuf101/foundry-zksync/issues/9909)) ([fdd78d9](https://github.com/SamYusuf101/foundry-zksync/commit/fdd78d9966c8ef553c2045842c982188fe54645b))
* **`Makefile`:** update `lint-foundry` target to explicitly use nightly ([#10526](https://github.com/SamYusuf101/foundry-zksync/issues/10526)) ([b47cf78](https://github.com/SamYusuf101/foundry-zksync/commit/b47cf78425f6d28bae5c90870eacbeea93c1a0e0))
* **`revm bump`:** re-add `P256` precompile injection for `forge` / `cast` ([#10555](https://github.com/SamYusuf101/foundry-zksync/issues/10555)) ([0ca8dd4](https://github.com/SamYusuf101/foundry-zksync/commit/0ca8dd47ef6b28aaf2d61837954ca73d4a0b435e))
* `vm.chainId` regression in isolation mode on `nightly` post `revm` bump ([#10589](https://github.com/SamYusuf101/foundry-zksync/issues/10589)) ([5a4b19e](https://github.com/SamYusuf101/foundry-zksync/commit/5a4b19e8d9ab332b9cbe18bd44c9cbdf5f8c8980))
* Add back test_zk_cast_call and test_zk_cast_call_create ([#933](https://github.com/SamYusuf101/foundry-zksync/issues/933)) ([b8a577e](https://github.com/SamYusuf101/foundry-zksync/commit/b8a577ed4816df84df437a5d456f9e04fe9012f5))
* add check for conflicting create ([#10467](https://github.com/SamYusuf101/foundry-zksync/issues/10467)) ([81b4679](https://github.com/SamYusuf101/foundry-zksync/commit/81b4679369f5014b481e06d33ffc772f83adcec6))
* Add depth adjustment on create for expectRevert ([#986](https://github.com/SamYusuf101/foundry-zksync/issues/986)) ([7f93bae](https://github.com/SamYusuf101/foundry-zksync/commit/7f93bae41eb932f4b756dfa04240b08a89179879))
* add support for inline `isolate` configuration ([#9904](https://github.com/SamYusuf101/foundry-zksync/issues/9904)) ([b184ebd](https://github.com/SamYusuf101/foundry-zksync/commit/b184ebd0f5214dd69f1fc3353e41bf334d471e00))
* add workaround for unlinked artifacts ([#10291](https://github.com/SamYusuf101/foundry-zksync/issues/10291)) ([bfb1cb6](https://github.com/SamYusuf101/foundry-zksync/commit/bfb1cb6b118b7e07a1de0fdea64a6cf44eb3a174))
* Added test for issue 1036 regarding crypto provider initialization ([#1038](https://github.com/SamYusuf101/foundry-zksync/issues/1038)) ([7461390](https://github.com/SamYusuf101/foundry-zksync/commit/7461390b11493e89d8d09974f0303aefcc5c9cf5))
* address issue with filtering create2 address factory  ([#1065](https://github.com/SamYusuf101/foundry-zksync/issues/1065)) ([f2aa902](https://github.com/SamYusuf101/foundry-zksync/commit/f2aa902841f3e820be32ccab56beb19f203341ab))
* address issue with replaying tx via cast run  ([#1071](https://github.com/SamYusuf101/foundry-zksync/issues/1071)) ([adb50e9](https://github.com/SamYusuf101/foundry-zksync/commit/adb50e9eb6331b2e81907a6ff117a5537d671938))
* addresses issue with state diff recording idx ([#1074](https://github.com/SamYusuf101/foundry-zksync/issues/1074)) ([41f3d53](https://github.com/SamYusuf101/foundry-zksync/commit/41f3d53a9bcea13a9bf9ea50d2eff6abecc32d23))
* adds zksync, abstract to diff gas calc ([#10539](https://github.com/SamYusuf101/foundry-zksync/issues/10539)) ([0f8a1ff](https://github.com/SamYusuf101/foundry-zksync/commit/0f8a1ff67a0a417acccc0869290b28a5c3cef3ce))
* allow init from template not commit ([ca9d1aa](https://github.com/SamYusuf101/foundry-zksync/commit/ca9d1aa4fb54e87f0e1ccad04e2b4f629b4520cc))
* allow init from template not commit ([6e919af](https://github.com/SamYusuf101/foundry-zksync/commit/6e919af69d7a9bb0dbb7508ac5402348140354c8))
* **anvil:** Fix tracing-subscriber initialization conflict in EIP4844 test ([#10249](https://github.com/SamYusuf101/foundry-zksync/issues/10249)) ([7c5f885](https://github.com/SamYusuf101/foundry-zksync/commit/7c5f88598fc803b1b4ec77ef0af5285e92770de4))
* **anvil:** recomputing next-base-fee after reloading state ([#10488](https://github.com/SamYusuf101/foundry-zksync/issues/10488)) ([e0ad278](https://github.com/SamYusuf101/foundry-zksync/commit/e0ad278c4433bc48f1c6ec902f72bf4d980957e0))
* **anvil:** reset cache path during anvil_reset without fork url ([#9729](https://github.com/SamYusuf101/foundry-zksync/issues/9729)) ([4974a08](https://github.com/SamYusuf101/foundry-zksync/commit/4974a0891bf01511993f49138ebf81f4be207cdf))
* **anvil:** return nonce and signature for deposit tx type ([#9883](https://github.com/SamYusuf101/foundry-zksync/issues/9883)) ([e5ec47b](https://github.com/SamYusuf101/foundry-zksync/commit/e5ec47b88208fdc48575359e0a5c44f85570ef63))
* **anvil:** trace_filter same to and from block range is valid ([#10400](https://github.com/SamYusuf101/foundry-zksync/issues/10400)) ([f3b9eaf](https://github.com/SamYusuf101/foundry-zksync/commit/f3b9eafdc6145287a865fe0adfac2ae0627046b0))
* **anvil:** use saturating_to when check for req funds ([#10503](https://github.com/SamYusuf101/foundry-zksync/issues/10503)) ([f240a34](https://github.com/SamYusuf101/foundry-zksync/commit/f240a34ac6824d7a5b3d7b25cb9dfe78aee2f4d4))
* avoid retrying verification for already verified contracts ([#1046](https://github.com/SamYusuf101/foundry-zksync/issues/1046)) ([9f59ff8](https://github.com/SamYusuf101/foundry-zksync/commit/9f59ff85664988a16d8e27c53dcba4d61ca2fe18))
* **bindings:** ensure forge bind generates snake_case file names ([#10622](https://github.com/SamYusuf101/foundry-zksync/issues/10622)) ([5e20961](https://github.com/SamYusuf101/foundry-zksync/commit/5e20961edeeab3c9c39dabe739ab7fba9a410fd2))
* build alpine/musl with cross ([#10086](https://github.com/SamYusuf101/foundry-zksync/issues/10086)) ([64a8bb0](https://github.com/SamYusuf101/foundry-zksync/commit/64a8bb0172b0ac53f9cd24e5f2b070068d0f1bd0))
* bump tokio version to fix RUSTSEC advisory ([#1014](https://github.com/SamYusuf101/foundry-zksync/issues/1014)) ([5c03679](https://github.com/SamYusuf101/foundry-zksync/commit/5c036796b5f3b3838216f477b3391fde18084fdd))
* Bump ubuntu on CI install ([#995](https://github.com/SamYusuf101/foundry-zksync/issues/995)) ([3f8025f](https://github.com/SamYusuf101/foundry-zksync/commit/3f8025f53f2c4cffe6ac4b43a3e20d4ebf993c6e))
* **cast:call:** remove debugging `is_zk` ([2eaac65](https://github.com/SamYusuf101/foundry-zksync/commit/2eaac658af0152576ce6515db650787199a4abb7))
* **cast:** allow user to disable block gas limit check in cast run ([#9996](https://github.com/SamYusuf101/foundry-zksync/issues/9996)) ([d1b1a25](https://github.com/SamYusuf101/foundry-zksync/commit/d1b1a250332d45dafe889593c2015e83b405bcb3))
* **cast:** clarify docs for the cast call --data flag ([#10014](https://github.com/SamYusuf101/foundry-zksync/issues/10014)) ([54af869](https://github.com/SamYusuf101/foundry-zksync/commit/54af8693b8fcc7a3f65136c1188e89661155955d))
* **cast:** disassembler PC & end of code push padding ([#10520](https://github.com/SamYusuf101/foundry-zksync/issues/10520)) ([73fec68](https://github.com/SamYusuf101/foundry-zksync/commit/73fec683a281be0d2215ab735fac43222e1fd358))
* **cast:** send should not panic on revert decoding ([#10155](https://github.com/SamYusuf101/foundry-zksync/issues/10155)) ([6e38c00](https://github.com/SamYusuf101/foundry-zksync/commit/6e38c00b467c86531d88b1d369b434ad776fd6ea))
* **cast:** try decoding custom errors when execution reverted in cast send ([#9794](https://github.com/SamYusuf101/foundry-zksync/issues/9794)) ([be5e714](https://github.com/SamYusuf101/foundry-zksync/commit/be5e7147bf60fb679a7b0016453dda49a4c6dac7))
* **cheatcode:** update revm with support for updated 7702 ([13051f0](https://github.com/SamYusuf101/foundry-zksync/commit/13051f0ea45b2c7de3a0a2e56a0a4c08f6aaba5b))
* **cheatcode:** update revm with support for updated 7702 ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* **cheatcode:** update revm with support for updated 7702 ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* **cheatcode:** update revm with support for updated 7702 ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* check for auth when deriving legacy ([#10619](https://github.com/SamYusuf101/foundry-zksync/issues/10619)) ([f86a66e](https://github.com/SamYusuf101/foundry-zksync/commit/f86a66ea206d5e3405dce7cdfffc7c843a8b43cf))
* **ci:** open issue after last retry fails ([#972](https://github.com/SamYusuf101/foundry-zksync/issues/972)) ([c75cca0](https://github.com/SamYusuf101/foundry-zksync/commit/c75cca066b48661c4ccb7febe1c3161adc771d67))
* **config:** enable optimizer if optimizer runs &gt; 0 in additional profiles ([#9901](https://github.com/SamYusuf101/foundry-zksync/issues/9901)) ([3d393b6](https://github.com/SamYusuf101/foundry-zksync/commit/3d393b6f1266c71f3b422a99b1a08852534d4db3))
* consistent nonce w/ tx batching ([#929](https://github.com/SamYusuf101/foundry-zksync/issues/929)) ([ae9cfd1](https://github.com/SamYusuf101/foundry-zksync/commit/ae9cfd10d906b5ab350258533219da1f4775c118))
* **coverage:** try/catch as branches, account for empty blocks ([#9978](https://github.com/SamYusuf101/foundry-zksync/issues/9978)) ([535acf4](https://github.com/SamYusuf101/foundry-zksync/commit/535acf42dd14060ef0dc174589f96f525b6a90a0))
* crossbeam-channel dep from rust advisory ([#1017](https://github.com/SamYusuf101/foundry-zksync/issues/1017)) ([44a1ce9](https://github.com/SamYusuf101/foundry-zksync/commit/44a1ce96227519d13d7380d40edf19abffc656ad))
* **docker:** build docker aarch64 without jemalloc ([#10286](https://github.com/SamYusuf101/foundry-zksync/issues/10286)) ([8d5c36f](https://github.com/SamYusuf101/foundry-zksync/commit/8d5c36fb2e951aebac2027d40a1120f6f1769efe))
* **docker:** use cross main instead 0.2.5 ([02f8c9a](https://github.com/SamYusuf101/foundry-zksync/commit/02f8c9a234755f0cc8cf1860399093d499c0d238))
* **docker:** use cross main instead 0.2.5 ([b384c96](https://github.com/SamYusuf101/foundry-zksync/commit/b384c96d318414f9d3b72c11ce839f8e7450709f))
* **docker:** use cross main, build docker only on release ([#10035](https://github.com/SamYusuf101/foundry-zksync/issues/10035)) ([b384c96](https://github.com/SamYusuf101/foundry-zksync/commit/b384c96d318414f9d3b72c11ce839f8e7450709f))
* Fix decode and field population in cast run ([#1047](https://github.com/SamYusuf101/foundry-zksync/issues/1047)) ([5401d27](https://github.com/SamYusuf101/foundry-zksync/commit/5401d27600a7d5d8179dcf38829da0b5964a3c17))
* fix formating crash caused by non-breaking space in comment ([1eb5988](https://github.com/SamYusuf101/foundry-zksync/commit/1eb598870e7e26a57d813e7584a0a5517566bdd9))
* fix formating crash caused by non-breaking space in comment ([4bcedfb](https://github.com/SamYusuf101/foundry-zksync/commit/4bcedfbc0b02ca53f34a91db75872bf773fd6e94))
* fix formating crash caused by non-breaking space in comment ([38536c9](https://github.com/SamYusuf101/foundry-zksync/commit/38536c965bde2d155666fdc2d54302b750edee02))
* fix formating crash caused by non-breaking space in comment. ([#10522](https://github.com/SamYusuf101/foundry-zksync/issues/10522)) ([38536c9](https://github.com/SamYusuf101/foundry-zksync/commit/38536c965bde2d155666fdc2d54302b750edee02))
* fix installation script for v0.0.6 ([#887](https://github.com/SamYusuf101/foundry-zksync/issues/887)) ([296c8f3](https://github.com/SamYusuf101/foundry-zksync/commit/296c8f3b14d7fe28ef6ed64592568cfed005e422))
* **fmt:** 'at' is not a keyword ([#10556](https://github.com/SamYusuf101/foundry-zksync/issues/10556)) ([d7cf0d3](https://github.com/SamYusuf101/foundry-zksync/commit/d7cf0d3cddb0a21a6d56c33ed7bf46de4a1585fd))
* **fmt:** 'layout' is not a keyword ([#10656](https://github.com/SamYusuf101/foundry-zksync/issues/10656)) ([7e68208](https://github.com/SamYusuf101/foundry-zksync/commit/7e68208eaae86342998f4a713d27a538ce5a3fbb))
* force install default crypto provider ([#10327](https://github.com/SamYusuf101/foundry-zksync/issues/10327)) ([709f266](https://github.com/SamYusuf101/foundry-zksync/commit/709f266ff6a26264ac4fc8c06cc40964861c7ebb))
* force prevrandao on rootstock network ([4add5dc](https://github.com/SamYusuf101/foundry-zksync/commit/4add5dcfa63d2631753ec7e84c5f20f1561ea8f3))
* force prevrandao on rootstock network ([f697e54](https://github.com/SamYusuf101/foundry-zksync/commit/f697e548f8d75d07b868ffe6975cc1bb3168d82d))
* force prevrandao on rootstock network ([5106b68](https://github.com/SamYusuf101/foundry-zksync/commit/5106b6845614ac830a9edcabf21ec0d1aa694d7e))
* force prevrandao on rootstock network ([1af14bc](https://github.com/SamYusuf101/foundry-zksync/commit/1af14bc9ecc3000cb4af52913579135525e68069))
* force prevrandao on rootstock network ([5b5bd7b](https://github.com/SamYusuf101/foundry-zksync/commit/5b5bd7b95f5f765abc84673c651e482f2fadc69b))
* force prevrandao on rootstock network ([25c363e](https://github.com/SamYusuf101/foundry-zksync/commit/25c363e0725d6be0992373b49d6ddec138ec8cf6))
* force prevrandao on rootstock testnet ([6aa835b](https://github.com/SamYusuf101/foundry-zksync/commit/6aa835bd9def31ec9a4bc22d8ab5cf130d446487))
* force prevrandao on rootstock testnet ([12c1178](https://github.com/SamYusuf101/foundry-zksync/commit/12c11781a61c3f81c8f891bb13ac1d14844bfe82))
* **forge init:** handle github.com/ prefixed templates ([#10151](https://github.com/SamYusuf101/foundry-zksync/issues/10151)) ([198f281](https://github.com/SamYusuf101/foundry-zksync/commit/198f281058b907419b2528feba50f620d9b6e08b))
* **forge lint:** do not flag `fn test*` and `fn invariant*` ([#10607](https://github.com/SamYusuf101/foundry-zksync/issues/10607)) ([e9496f6](https://github.com/SamYusuf101/foundry-zksync/commit/e9496f656485c728318dcb5c7072f8a52148ccb7))
* **forge:** allow `forge init --template` to work with `--no-commit` ([#9815](https://github.com/SamYusuf101/foundry-zksync/issues/9815)) ([6e919af](https://github.com/SamYusuf101/foundry-zksync/commit/6e919af69d7a9bb0dbb7508ac5402348140354c8))
* **forge:** allow install deps with https and gh token ([13051f0](https://github.com/SamYusuf101/foundry-zksync/commit/13051f0ea45b2c7de3a0a2e56a0a4c08f6aaba5b))
* **forge:** allow install deps with https and gh token ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* **forge:** allow install deps with https and gh token ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* **forge:** allow install deps with https and gh token ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* **forge:** apply startPrank with delegate only for top calls ([#10069](https://github.com/SamYusuf101/foundry-zksync/issues/10069)) ([3accf6b](https://github.com/SamYusuf101/foundry-zksync/commit/3accf6b730c030ad2f4b70595de5445443876afd))
* **forge:** avoid etch panic on invalid bytecode ([#10006](https://github.com/SamYusuf101/foundry-zksync/issues/10006)) ([09b0a0c](https://github.com/SamYusuf101/foundry-zksync/commit/09b0a0c075eba85324a27cf7ed2e63d829df884c))
* **forge:** avoid panic on internal decoding of linked tests ([#10333](https://github.com/SamYusuf101/foundry-zksync/issues/10333)) ([f76309d](https://github.com/SamYusuf101/foundry-zksync/commit/f76309dad7dddc0917755d3f3d17e1ad9d02c6b8))
* **forge:** avoid preprocessor constructor args struct name conflict ([#10313](https://github.com/SamYusuf101/foundry-zksync/issues/10313)) ([ac724c2](https://github.com/SamYusuf101/foundry-zksync/commit/ac724c20f1f938676ed876310a51fe954135a9e1))
* **forge:** bail if forge create contract with empty bytecode ([#10159](https://github.com/SamYusuf101/foundry-zksync/issues/10159)) ([c9bc31e](https://github.com/SamYusuf101/foundry-zksync/commit/c9bc31e71e9f87c4c9afd3a4534590f42b7303b7))
* **forge:** base url for custom verification providers type ([02f8c9a](https://github.com/SamYusuf101/foundry-zksync/commit/02f8c9a234755f0cc8cf1860399093d499c0d238))
* **forge:** base url for custom verification providers type ([0a2ad00](https://github.com/SamYusuf101/foundry-zksync/commit/0a2ad0034dded199812bc9a97ea96f59f9b87354))
* **forge:** base url for verification providers other than etherscan ([#10045](https://github.com/SamYusuf101/foundry-zksync/issues/10045)) ([0a2ad00](https://github.com/SamYusuf101/foundry-zksync/commit/0a2ad0034dded199812bc9a97ea96f59f9b87354))
* **forge:** clone src with node_modules ([#10119](https://github.com/SamYusuf101/foundry-zksync/issues/10119)) ([f12f8a2](https://github.com/SamYusuf101/foundry-zksync/commit/f12f8a22fe396431011f71b4270edc90cc436fd9))
* **forge:** coverage for contracts with ctor with args ([#10270](https://github.com/SamYusuf101/foundry-zksync/issues/10270)) ([c0914e4](https://github.com/SamYusuf101/foundry-zksync/commit/c0914e4d86d0f53abe8a5683c486219d6ea5c40b))
* **forge:** decode fallbacks with calldata ([#9859](https://github.com/SamYusuf101/foundry-zksync/issues/9859)) ([55785b7](https://github.com/SamYusuf101/foundry-zksync/commit/55785b73f026576234f02e1eb6e9605c74643017))
* **forge:** do not panic if create fork err ([#10231](https://github.com/SamYusuf101/foundry-zksync/issues/10231)) ([58cae24](https://github.com/SamYusuf101/foundry-zksync/commit/58cae24dff2876f09433386b071c7bdb3ddafa50))
* **forge:** do not panic if revert at same depth as start state recording ([#10016](https://github.com/SamYusuf101/foundry-zksync/issues/10016)) ([71e8e0f](https://github.com/SamYusuf101/foundry-zksync/commit/71e8e0f2d09ab8d8c8d8a2daa46c1c38ed80bd4b))
* **forge:** do not revert if event with count 0 not emitted ([#10534](https://github.com/SamYusuf101/foundry-zksync/issues/10534)) ([447ef28](https://github.com/SamYusuf101/foundry-zksync/commit/447ef284e6fc1210028ce6bcffad1c87c9fb7df4))
* **forge:** do not set balance as apparent value in delegate prank ([#10304](https://github.com/SamYusuf101/foundry-zksync/issues/10304)) ([314eded](https://github.com/SamYusuf101/foundry-zksync/commit/314eded9b6e801d0870b4c7c2b1d1a57f58d5203))
* **forge:** do not use bytecode metadata in fuzz dict ([#10402](https://github.com/SamYusuf101/foundry-zksync/issues/10402)) ([96f6ffe](https://github.com/SamYusuf101/foundry-zksync/commit/96f6ffe0750dfbd5639034f95e0c974d93d6f369))
* **forge:** do not use metadata in fuzzing ([96f6ffe](https://github.com/SamYusuf101/foundry-zksync/commit/96f6ffe0750dfbd5639034f95e0c974d93d6f369))
* **forge:** ensure selected fork contains init state for persisted accounts ([#10301](https://github.com/SamYusuf101/foundry-zksync/issues/10301)) ([b75625a](https://github.com/SamYusuf101/foundry-zksync/commit/b75625abc36152b3fd205a820cd4066ea7316df5))
* **forge:** err if forge create contract with empty bytecode ([4add5dc](https://github.com/SamYusuf101/foundry-zksync/commit/4add5dcfa63d2631753ec7e84c5f20f1561ea8f3))
* **forge:** err if forge create contract with empty bytecode ([4add5dc](https://github.com/SamYusuf101/foundry-zksync/commit/4add5dcfa63d2631753ec7e84c5f20f1561ea8f3))
* **forge:** err if forge create contract with empty bytecode ([f697e54](https://github.com/SamYusuf101/foundry-zksync/commit/f697e548f8d75d07b868ffe6975cc1bb3168d82d))
* **forge:** err if forge create contract with empty bytecode ([f697e54](https://github.com/SamYusuf101/foundry-zksync/commit/f697e548f8d75d07b868ffe6975cc1bb3168d82d))
* **forge:** err if forge create contract with empty bytecode ([5106b68](https://github.com/SamYusuf101/foundry-zksync/commit/5106b6845614ac830a9edcabf21ec0d1aa694d7e))
* **forge:** err if forge create contract with empty bytecode ([1af14bc](https://github.com/SamYusuf101/foundry-zksync/commit/1af14bc9ecc3000cb4af52913579135525e68069))
* **forge:** err if forge create contract with empty bytecode ([5b5bd7b](https://github.com/SamYusuf101/foundry-zksync/commit/5b5bd7b95f5f765abc84673c651e482f2fadc69b))
* **forge:** err if forge create contract with empty bytecode ([5b5bd7b](https://github.com/SamYusuf101/foundry-zksync/commit/5b5bd7b95f5f765abc84673c651e482f2fadc69b))
* **forge:** err if forge create contract with empty bytecode ([87cbe16](https://github.com/SamYusuf101/foundry-zksync/commit/87cbe1659dfc2e27f87e505709a0a2fcb90c79b0))
* **forge:** err if forge create contract with empty bytecode ([c9bc31e](https://github.com/SamYusuf101/foundry-zksync/commit/c9bc31e71e9f87c4c9afd3a4534590f42b7303b7))
* **forge:** fix nonce for tx with 7702 auth ([#10464](https://github.com/SamYusuf101/foundry-zksync/issues/10464)) ([755cee0](https://github.com/SamYusuf101/foundry-zksync/commit/755cee06c510d426f3da4ec834a2eaa1d1b02179))
* **forge:** flatten fails on top-level event declarations ([#9892](https://github.com/SamYusuf101/foundry-zksync/issues/9892)) ([29cba10](https://github.com/SamYusuf101/foundry-zksync/commit/29cba10c737636d0000ef6ad5de8d08df267ac60))
* **forge:** mark prank applied on contract creation too ([#10532](https://github.com/SamYusuf101/foundry-zksync/issues/10532)) ([fb9904b](https://github.com/SamYusuf101/foundry-zksync/commit/fb9904b17c070ea74f4fc4525c00bc6c403c0acb))
* **forge:** redact pk in signDelegation* traces ([#10061](https://github.com/SamYusuf101/foundry-zksync/issues/10061)) ([56708cf](https://github.com/SamYusuf101/foundry-zksync/commit/56708cf29cd42ee853f8d918c4555a4458caf9a3))
* **forge:** remove `strategy` section from workflow template to simplify ([#10434](https://github.com/SamYusuf101/foundry-zksync/issues/10434)) ([a34f4c9](https://github.com/SamYusuf101/foundry-zksync/commit/a34f4c989b94f572497631ff5c85909d674c23a6))
* **forge:** respect --optimize flag when verify with forge create ([#10163](https://github.com/SamYusuf101/foundry-zksync/issues/10163)) ([a1bb657](https://github.com/SamYusuf101/foundry-zksync/commit/a1bb65732435f80d23af1b232d17b206af29841a))
* **forge:** run git submodule sync when installing ([#10347](https://github.com/SamYusuf101/foundry-zksync/issues/10347)) ([8690fef](https://github.com/SamYusuf101/foundry-zksync/commit/8690fefcce1e77e01cd03c3d91c5e5a9f0723abc))
* **forge:** Set empty code if the 7702 delegation address is 0x ([#10481](https://github.com/SamYusuf101/foundry-zksync/issues/10481)) ([90a8746](https://github.com/SamYusuf101/foundry-zksync/commit/90a8746d2938320ad50226d3f978318557ae5575))
* **forge:** Set empty code if the 7702 delegation address of authority is 0x ([90a8746](https://github.com/SamYusuf101/foundry-zksync/commit/90a8746d2938320ad50226d3f978318557ae5575))
* **forge:** show lcov hits for do while statements ([#10423](https://github.com/SamYusuf101/foundry-zksync/issues/10423)) ([b28c2b2](https://github.com/SamYusuf101/foundry-zksync/commit/b28c2b210450232b5a5cf649926398985306a750))
* **forge:** stack pranks, restore pranks at earlier call depths ([#10018](https://github.com/SamYusuf101/foundry-zksync/issues/10018)) ([23191fb](https://github.com/SamYusuf101/foundry-zksync/commit/23191fbeccfcf901f7c28590cb962d9693373c21))
* **forge:** support preproc with try contract creation ([#10498](https://github.com/SamYusuf101/foundry-zksync/issues/10498)) ([12b2ed4](https://github.com/SamYusuf101/foundry-zksync/commit/12b2ed44f8d0667b3c10ce58493466484a66c245))
* **forge:** trace identify by creation code with stripped args ([#10271](https://github.com/SamYusuf101/foundry-zksync/issues/10271)) ([5bd034f](https://github.com/SamYusuf101/foundry-zksync/commit/5bd034f33366020f4d5137ad54218e0b978c0869))
* **forge:** use etherscan verifier if key provided ([#10058](https://github.com/SamYusuf101/foundry-zksync/issues/10058)) ([aca13d0](https://github.com/SamYusuf101/foundry-zksync/commit/aca13d04bd5bceaed994f7ae482780caac556658))
* **forge:** use float total cmp instead partial ([#10005](https://github.com/SamYusuf101/foundry-zksync/issues/10005)) ([d3704ee](https://github.com/SamYusuf101/foundry-zksync/commit/d3704ee2bb6d2565ac746ed3951666932b287487))
* **forge:** use total cmp instead partial ([d3704ee](https://github.com/SamYusuf101/foundry-zksync/commit/d3704ee2bb6d2565ac746ed3951666932b287487))
* **forge:** vm.cool mark cold instead storage cleaning ([#10546](https://github.com/SamYusuf101/foundry-zksync/issues/10546)) ([d381a8a](https://github.com/SamYusuf101/foundry-zksync/commit/d381a8aab3196ca53366e2584bcdb4210febfc5c))
* **forge:** warn if file for artifact no longer exists ([#10025](https://github.com/SamYusuf101/foundry-zksync/issues/10025)) ([dc69097](https://github.com/SamYusuf101/foundry-zksync/commit/dc69097e7d355c991996068bef861354dc72cc55))
* foundry man artifact name ([#886](https://github.com/SamYusuf101/foundry-zksync/issues/886)) ([62d5ff6](https://github.com/SamYusuf101/foundry-zksync/commit/62d5ff66cae2af74f4fad8524337a33394ae8437))
* foundry toml invalid setting does not discard other settings ([#912](https://github.com/SamYusuf101/foundry-zksync/issues/912)) ([27eda8b](https://github.com/SamYusuf101/foundry-zksync/commit/27eda8b39ee5fef6997c6993ccea771b0439b6db))
* **foundryup:** install for user names with empty space ([#9835](https://github.com/SamYusuf101/foundry-zksync/issues/9835)) ([867484f](https://github.com/SamYusuf101/foundry-zksync/commit/867484fc9338a0174d637435283774e5da783f27))
* handle invalid mnemonic gracefully in anvil ([#10207](https://github.com/SamYusuf101/foundry-zksync/issues/10207)) ([f45781d](https://github.com/SamYusuf101/foundry-zksync/commit/f45781dd1df8e008613b04871c2fc63cf7949eda))
* incorrect repo link ([13051f0](https://github.com/SamYusuf101/foundry-zksync/commit/13051f0ea45b2c7de3a0a2e56a0a4c08f6aaba5b))
* incorrect repo link ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* incorrect repo link ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* incorrect repo link ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* Increase max depth for EraVM calls ([#979](https://github.com/SamYusuf101/foundry-zksync/issues/979)) ([f28f94f](https://github.com/SamYusuf101/foundry-zksync/commit/f28f94f5880902ef96866a75b589f73652524142))
* **inspect:** add flag to strip ir comments ([#9825](https://github.com/SamYusuf101/foundry-zksync/issues/9825)) ([91740aa](https://github.com/SamYusuf101/foundry-zksync/commit/91740aa82f7b43f142ccfec87148340f520ba153))
* **inspector:** missing field in default ([f3a9825](https://github.com/SamYusuf101/foundry-zksync/commit/f3a9825a9b07bee979c94bc26cc80ccc96942eb5))
* **invariant:** ignore persisted failure if different test contract ([#9981](https://github.com/SamYusuf101/foundry-zksync/issues/9981)) ([bd9f4c1](https://github.com/SamYusuf101/foundry-zksync/commit/bd9f4c1c601b47defd10f266175e15013d27196b))
* **isolate:** do not mark cold accounts with arbitrary storage ([#9945](https://github.com/SamYusuf101/foundry-zksync/issues/9945)) ([879154c](https://github.com/SamYusuf101/foundry-zksync/commit/879154ca5d77af5c9feee4f5f1b10f4e12b1ae4e))
* make sign and verify symmetrical ([#10614](https://github.com/SamYusuf101/foundry-zksync/issues/10614)) ([1353416](https://github.com/SamYusuf101/foundry-zksync/commit/135341634a3415b10141c1fbd136585f946f7ed5))
* map 7623 to gas too high ([#9915](https://github.com/SamYusuf101/foundry-zksync/issues/9915)) ([c34a752](https://github.com/SamYusuf101/foundry-zksync/commit/c34a752532c23aac999a3c62fdf45d0db6df2d26))
* mark metis as different gas calc ([#9834](https://github.com/SamYusuf101/foundry-zksync/issues/9834)) ([d65ede5](https://github.com/SamYusuf101/foundry-zksync/commit/d65ede582153cc3f9319067bb7bf7a5adbf88c15))
* Migrate test contract to EraVM state ([#1078](https://github.com/SamYusuf101/foundry-zksync/issues/1078)) ([4c58f0a](https://github.com/SamYusuf101/foundry-zksync/commit/4c58f0a5074f0f9cc71f2b950fad6360a7dda6d7))
* Nonce mismatch when broadcasting in setup function  ([#923](https://github.com/SamYusuf101/foundry-zksync/issues/923)) ([cdef273](https://github.com/SamYusuf101/foundry-zksync/commit/cdef273ef198820ac6fa390bc868c6c8aa5cbab2))
* normalize signature s value ([#10180](https://github.com/SamYusuf101/foundry-zksync/issues/10180)) ([539fd96](https://github.com/SamYusuf101/foundry-zksync/commit/539fd9611e213c0e72e5524b6030d00bf21c9587))
* patch solang-parser ([#10509](https://github.com/SamYusuf101/foundry-zksync/issues/10509)) ([dc6a216](https://github.com/SamYusuf101/foundry-zksync/commit/dc6a2160ef1cecf21531eaf6722af9f7f64ca3c7))
* pin to `macos-13-large` for release flow to support old SDK versions ([#9870](https://github.com/SamYusuf101/foundry-zksync/issues/9870)) ([c0664e8](https://github.com/SamYusuf101/foundry-zksync/commit/c0664e8873c869b656cc66f6c97856ab06bc5838))
* propagate error on backend spawn fork ([4add5dc](https://github.com/SamYusuf101/foundry-zksync/commit/4add5dcfa63d2631753ec7e84c5f20f1561ea8f3))
* propagate error on backend spawn fork ([f697e54](https://github.com/SamYusuf101/foundry-zksync/commit/f697e548f8d75d07b868ffe6975cc1bb3168d82d))
* propagate error on backend spawn fork ([5106b68](https://github.com/SamYusuf101/foundry-zksync/commit/5106b6845614ac830a9edcabf21ec0d1aa694d7e))
* propagate error on backend spawn fork ([1af14bc](https://github.com/SamYusuf101/foundry-zksync/commit/1af14bc9ecc3000cb4af52913579135525e68069))
* propagate error on backend spawn fork ([5b5bd7b](https://github.com/SamYusuf101/foundry-zksync/commit/5b5bd7b95f5f765abc84673c651e482f2fadc69b))
* propagate error on backend spawn fork ([58cae24](https://github.com/SamYusuf101/foundry-zksync/commit/58cae24dff2876f09433386b071c7bdb3ddafa50))
* **receipt:** use `from` address ([#9998](https://github.com/SamYusuf101/foundry-zksync/issues/9998)) ([e7a840f](https://github.com/SamYusuf101/foundry-zksync/commit/e7a840f24f10949fb7991ef3d06d6aff8dafafe5))
* refactor `step` and `step_end` for clarity ([#10590](https://github.com/SamYusuf101/foundry-zksync/issues/10590)) ([4a7f84b](https://github.com/SamYusuf101/foundry-zksync/commit/4a7f84b3a13fbb0cd2efeee471611e0852699ebd))
* Replay raw txs without tweaks in anvil_reorg ([#10442](https://github.com/SamYusuf101/foundry-zksync/issues/10442)) ([a31d9be](https://github.com/SamYusuf101/foundry-zksync/commit/a31d9be30bb5a2f07c5ceac22affe1b4c6622993))
* Replay raw txs without txs in anvil_reorg ([a31d9be](https://github.com/SamYusuf101/foundry-zksync/commit/a31d9be30bb5a2f07c5ceac22affe1b4c6622993))
* Resolve codespell error in changelog ([#1058](https://github.com/SamYusuf101/foundry-zksync/issues/1058)) ([f92cc90](https://github.com/SamYusuf101/foundry-zksync/commit/f92cc907b9e28c55ba1199d7fc032145901bbb0c))
* respect full arg ([9e53778](https://github.com/SamYusuf101/foundry-zksync/commit/9e53778208a2cdb335d5ef794cb13122b8288364))
* **script:** apply configured evm-version for verify args ([#9979](https://github.com/SamYusuf101/foundry-zksync/issues/9979)) ([86422ee](https://github.com/SamYusuf101/foundry-zksync/commit/86422eecb6aea075dbd2e3c167939f60f343c1ff))
* sort blocks by number ([#10505](https://github.com/SamYusuf101/foundry-zksync/issues/10505)) ([0a7b3f0](https://github.com/SamYusuf101/foundry-zksync/commit/0a7b3f02b559fcb884f9886274f04a89dec15f9c))
* **trace_filter:** allow params to be object or array with len 1 ([#9793](https://github.com/SamYusuf101/foundry-zksync/issues/9793)) ([3d48000](https://github.com/SamYusuf101/foundry-zksync/commit/3d480003b71d1cab59ba44191eed8905ded8ce37))
* **trace_filter:** change params objects to deserialize only an array ([ca9d1aa](https://github.com/SamYusuf101/foundry-zksync/commit/ca9d1aa4fb54e87f0e1ccad04e2b4f629b4520cc))
* **trace_filter:** change params objects to deserialize only an array ([3d48000](https://github.com/SamYusuf101/foundry-zksync/commit/3d480003b71d1cab59ba44191eed8905ded8ce37))
* trim tag name to obtain version ([#885](https://github.com/SamYusuf101/foundry-zksync/issues/885)) ([113501c](https://github.com/SamYusuf101/foundry-zksync/commit/113501c28a53e95393e20f1ab37df8848b472b95))
* un-ignore test ([#978](https://github.com/SamYusuf101/foundry-zksync/issues/978)) ([8daf45f](https://github.com/SamYusuf101/foundry-zksync/commit/8daf45fa0a55c823a3642b188795a64e5a966ec3))
* updates anvil-zksync and filter non-kernel contracts ([#1062](https://github.com/SamYusuf101/foundry-zksync/issues/1062)) ([747cec5](https://github.com/SamYusuf101/foundry-zksync/commit/747cec5cb6080bb0dccdd35880d0c8e5abe270b9))
* Use alchemy api key for ETH RPC URL ([#1003](https://github.com/SamYusuf101/foundry-zksync/issues/1003)) ([75e5fa9](https://github.com/SamYusuf101/foundry-zksync/commit/75e5fa91ba3822ec5cd51d5154b8b16dc1f8db41))
* use existing deployment nonce during storage migration ([#895](https://github.com/SamYusuf101/foundry-zksync/issues/895)) ([857d5d2](https://github.com/SamYusuf101/foundry-zksync/commit/857d5d252110dcbea3fe7731d3f38103c93a2dd7))
* Use new alchemy key to avoid rate limiting issues ([#919](https://github.com/SamYusuf101/foundry-zksync/issues/919)) ([89fa128](https://github.com/SamYusuf101/foundry-zksync/commit/89fa12899e7407576f29297b80b0fa161e6532c5))
* use sequence for rollback ([#9795](https://github.com/SamYusuf101/foundry-zksync/issues/9795)) ([7c3bf09](https://github.com/SamYusuf101/foundry-zksync/commit/7c3bf09ce34822b704fc18db5b554dbf032f4535))
* Use the unused skip_extra_derives bind argument ([#10099](https://github.com/SamYusuf101/foundry-zksync/issues/10099)) ([3665ff5](https://github.com/SamYusuf101/foundry-zksync/commit/3665ff5f79ad9a558d0fb73fef0ca7137447fd97))
* use ubuntu:22.04 ([13051f0](https://github.com/SamYusuf101/foundry-zksync/commit/13051f0ea45b2c7de3a0a2e56a0a4c08f6aaba5b))
* use ubuntu:22.04 ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* use ubuntu:22.04 ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* use ubuntu:22.04 ([e98c3fe](https://github.com/SamYusuf101/foundry-zksync/commit/e98c3fe12c02142af92a5a755013983842f6fac5))
* **verfy:** add blockscout exception for resp status 0 when contract not indexed ([#10008](https://github.com/SamYusuf101/foundry-zksync/issues/10008)) ([e734c2d](https://github.com/SamYusuf101/foundry-zksync/commit/e734c2dae1c30020579a4d19c69b909578142433))
* **verfy:** chiado blockscout exception, resp status 0 when contract not indexed yet ([e734c2d](https://github.com/SamYusuf101/foundry-zksync/commit/e734c2dae1c30020579a4d19c69b909578142433))
* **zk:warp:** only affect timestamp ([#963](https://github.com/SamYusuf101/foundry-zksync/issues/963)) ([9c40e44](https://github.com/SamYusuf101/foundry-zksync/commit/9c40e44cffab00a6035279d7de7e9395d33f3209))


### Performance Improvements

* find latest block for next-base-fee. replaces [#10505](https://github.com/SamYusuf101/foundry-zksync/issues/10505) ([#10511](https://github.com/SamYusuf101/foundry-zksync/issues/10511)) ([58297d3](https://github.com/SamYusuf101/foundry-zksync/commit/58297d3457569989bc5cfbcf88ac43766fa8f4b3))
* improve zksync runtime ([#962](https://github.com/SamYusuf101/foundry-zksync/issues/962)) ([f14925c](https://github.com/SamYusuf101/foundry-zksync/commit/f14925cdfd4c618f4c642203995cf945f42cb415))
* spawn mining on blocking ([#10471](https://github.com/SamYusuf101/foundry-zksync/issues/10471)) ([9e5f4b9](https://github.com/SamYusuf101/foundry-zksync/commit/9e5f4b97ea48e7743c20b5c8a0cd4e68f7f3197d))
